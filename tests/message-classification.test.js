...
test('message classifier rejects clips, services, and music before accepting sermons', function () {
  ...
  assert.equal(classifyVideo({
    title: 'Faith in the Storm | Acts 16 | Pastor J. Bret Wiley',
...
test('Studio type overrides are authoritative', function () {
  ...
  const sermon = { id: 'sermon123456', title: 'Grace | Romans 5 | Pastor J. Bret Wiley', duration: 2200 };
...
test('a newly posted dated sermon remains a message, not a service', function () {
  assert.equal(classifyVideo({
    id: 'sQEFoM5UzeM',
    title: 'A Message of Hope | 6.26.26 | Pastor J. Bret Wiley',
    description: 'Pastor J. Bret Wiley preaches from Psalm 121.',
    duration: 3000,
  }), 'message');
});
...
test('sitemap includes auto-classified and explicit messages without leaking other video types', function () {
  const catalog = { items: [
    { id: 'sermon123456', title: 'Grace | Romans 5 | Pastor J. Bret Wiley', duration: 2200, published: '2026-07-01T12:00:00Z' },
    ...
    { id: 'forcedclip12', title: 'John 3 | Pastor J. Bret Wiley', duration: 2100, published: '2026-07-04T12:00:00Z' },
  ] };
